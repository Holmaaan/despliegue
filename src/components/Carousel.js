...
import image1 from '../assets/History-Page-Main-Banner-min.jpg'; // Asegúrate de que la ruta sea correcta
import image2 from '../assets/History-Page-Main-Banner-min.jpg'; // Asegúrate de que la ruta sea correcta
