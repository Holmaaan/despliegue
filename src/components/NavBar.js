        ...
        <AppBar position="static" sx={{ backgroundColor: 'black' }}>
            <Toolbar>
                <Box sx={{ display: 'flex', flexGrow: 1, justifyContent: 'center' }}>
                    ...
                    <Button color="inherit" component={Link} to="/products" sx={{ fontFamily: 'Roboto, sans-serif', fontSize: '16px' }}>
                        Gorras
                    </Button>
                    <Button color="inherit" component={Link} to="/about" sx={{ fontFamily: 'Roboto, sans-serif', fontSize: '16px' }}>
                        Acerca
                    </Button>
                </Box>
                <Box sx={{ display: 'flex' }}>
